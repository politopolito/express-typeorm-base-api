...
describe("PhotoService", () => {
  ...
  it("getById success", async () => {
    ...
    // Then
    expect(fakeRepo.findById.calledOnceWithExactly(photoMock.id, undefined)).toBeTruthy();
  ...
  it("getById not found", async () => {
    ...
    expect(fakeRepo.findById.calledOnceWithExactly(999, undefined)).toBeTruthy();
  });
